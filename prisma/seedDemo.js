...
async function main() {
  ...
  const items = await Promise.all([
    ...
    prisma.item.create({ data: {
      ...
      title: 'Rossignol Experience 82 Alpine Skis',
    ...
    prisma.item.create({ data: {
      ...
      categoryTier2: 'Winter Sports',
      categoryTier3: 'Alpine Skis',
      title: 'K2 Mindbender 108 Powder Skis',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Salomon X Access 80 Ski Boots',
    ...
    prisma.item.create({ data: {
      ...
      categoryTier2: 'Winter Sports',
      categoryTier3: 'Ski Boots (Alpine)',
      title: 'Nordica Sportmachine 100 Ski Boots',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Burton Custom 155 All-Mountain Snowboard',
    ...
    prisma.item.create({ data: {
      ...
      categoryTier2: 'Winter Sports',
      categoryTier3: 'Snowboard',
      title: 'Ride Twinpig Freestyle Snowboard',
    ...
    prisma.item.create({ data: {
      ...
      title: 'DeWalt 12" Sliding Compound Miter Saw',
    ...
    prisma.item.create({ data: {
      ...
      title: 'DeWalt 10" Portable Table Saw',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Werner 20ft Fiberglass Extension Ladder',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Kids Bounce House with Slide',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Epson Projector with 120" Screen',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Ford F-250 Super Duty Pickup',
    ...
    prisma.item.create({ data: {
      ...
      title: 'REI Co-op Passage 4 Tent',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Experienced Handyman - General Repairs',
    ...
    prisma.item.create({ data: {
      ...
      title: 'Moving Help - 2 Strong Guys + Truck',
